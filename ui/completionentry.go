// Package ui
//
//	this file are copy pasted from: https://github.com/fyne-io/fyne-x/blob/master/widget/completionentry.go
package ui
...
type CompletionEntry struct {
	...
	CustomSetText func(selectedOpt string) string
}
...
func (c *CompletionEntry) setTextFromMenu(s string) {
	...
	// allow set text to be overrideable
	if c.CustomSetText == nil {
		c.Entry.SetText(s)
	} else {
		c.Entry.SetText(c.CustomSetText(s))
	}
